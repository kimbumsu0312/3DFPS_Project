...
CVIBuffer_Line::CVIBuffer_Line(ID3D11Device* pDevice, ID3D11DeviceContext* pContext) : CVIBuffer{ pDevice, pContext }
{
}

CVIBuffer_Line::CVIBuffer_Line(const CVIBuffer_Line& Prototype) : CVIBuffer(Prototype)
{
}
...
CVIBuffer_Line* CVIBuffer_Line::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, const _float3* pPoints)
{
	...
	{
		MSG_BOX(TEXT("Failed to Crated : CVIBuffer_Line"));
