...
CBounding_AABB::CBounding_AABB(ID3D11Device* pDevice, ID3D11DeviceContext* pContext) : CBounding { pDevice, pContext }
{
}
...
_bool CBounding_AABB::Intersect(_vector RayPos, _vector RayDir)
{
    _bool isColl = { false };
    _float fDis = {};
