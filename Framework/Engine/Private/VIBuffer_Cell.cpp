...
CVIBuffer_Cell::CVIBuffer_Cell(ID3D11Device* pDevice, ID3D11DeviceContext* pContext) : CVIBuffer { pDevice, pContext}
{
}

CVIBuffer_Cell::CVIBuffer_Cell(const CVIBuffer_Cell& Prototype) : CVIBuffer( Prototype )
{
}
...
CVIBuffer_Cell* CVIBuffer_Cell::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, const _float3* pPoints)
{
	...
	{
		MSG_BOX(TEXT("Failed to Crated : CVIBuffer_Cell"));
