...
namespace Client
{
	...
	const vector<InvenItemData> g_ItemData =
	{
		...
		InvenItemData(0			,TEXT("LEMI"),					ITEM_TYPE::WEAPON		,3			,2			,2			,2		,{12, 1257}		,{89, 1332}		,15			,0			,QUICKSLOT_TYPE::EQUIP			,0		,TEXT("Æò±ÕÀûÀÎ À§·ÂÀ» °¡Áø ÀÛ°í »ç¿ëÇÏ±â ½¬¿î ¹ÝÀÚµ¿ ÇÇ½ºÅç.")			),
		InvenItemData(1			,TEXT("M1897"),					ITEM_TYPE::WEAPON		,5			,2			,4			,2		,{188, 1258}	,{388, 1332}	,2			,0			,QUICKSLOT_TYPE::EQUIP			,1		,TEXT("ÁÖ·Î »ç³É¿¡ ¸¹ÀÌ ¾²ÀÌ´Â ÆßÇÁ ¿¬»ç½Ä »êÅºÃÑ.")			),
		...
		InvenItemData(5			,TEXT("±ÇÃÑ ÃÑ¾Ë"),				ITEM_TYPE::ITEM			,2			,1			,1.5f		,1.f	,{5, 215}		,{89, 259}		,30			,15			,QUICKSLOT_TYPE::NONE			,0		,TEXT("±ÇÃÑ ÃÑ¾Ë")		),
		InvenItemData(6			,TEXT("¼¦°Ç ÃÑ¾Ë"),				ITEM_TYPE::ITEM			,2			,1			,1.5f		,0.9f	,{103, 215}		,{189, 259}		,8			,4			,QUICKSLOT_TYPE::NONE			,0		,TEXT("¼¦°Ç ÃÑ¾Ë")		),
		InvenItemData(7			,TEXT("½º³ªÀÌÆÛ ÃÑ¾Ë"),			ITEM_TYPE::ITEM			,2			,1			,2			,0.9f	,{483, 215}		,{576, 259}		,12			,6			,QUICKSLOT_TYPE::NONE			,1		,TEXT("½º³ªÀÌÆÛ ÃÑ¾Ë")	),
	};	
