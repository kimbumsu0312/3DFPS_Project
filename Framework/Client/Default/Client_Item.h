...
namespace Client
{
	...
	const vector<InvenItemData> g_ItemData =
	{
		...
		InvenItemData(5			,TEXT("권총 총알"),				ITEM_TYPE::ITEM			,2			,1			,1.5f		,1.f	,{5, 215}		,{89, 259}		,30			,10			,QUICKSLOT_TYPE::NONE			,-1		,TEXT("권총 총알")		),
		InvenItemData(6			,TEXT("샷건 총알"),				ITEM_TYPE::ITEM			,2			,1			,1.5f		,0.9f	,{103, 215}		,{189, 259}		,6			,3			,QUICKSLOT_TYPE::NONE			,-1		,TEXT("샷건 총알")		),
