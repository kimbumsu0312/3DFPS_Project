...
CQuick_Slot_Item::CQuick_Slot_Item(ID3D11Device* pDevice, ID3D11DeviceContext* pContext) : CUIObject{ pDevice, pContext }
{
}

CQuick_Slot_Item::CQuick_Slot_Item(const CQuick_Slot_Item& Prototype) : CUIObject(Prototype)
{
}

HRESULT CQuick_Slot_Item::Initialize_Prototype()
{

    return S_OK;
}

HRESULT CQuick_Slot_Item::Initialize(void* pArg)
{
    if (pArg == nullptr)
        return E_FAIL;
...
void CQuick_Slot_Item::Priority_Update(_float fTimeDelta)
{
    if (m_iItemIndex < 0)
        return;
}

void CQuick_Slot_Item::Update(_float fTimeDelta)
{
    if (m_iItemIndex < 0)
        return;
    switch (m_iITemType)
...
void CQuick_Slot_Item::Late_Update(_float fTimeDelta)
{
    if (m_iItemIndex < 0)
        return;
...
HRESULT CQuick_Slot_Item::Render()
{
...
HRESULT CQuick_Slot_Item::Ready_Components()
{
...
void CQuick_Slot_Item::Set_Item(_int iItemIndex)
{
...
CQuick_Slot_Item* CQuick_Slot_Item::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
    CQuick_Slot_Item* pInstance = new CQuick_Slot_Item(pDevice, pContext);

    if (FAILED(pInstance->Initialize_Prototype()))
    {
        MSG_BOX(TEXT("Failed to Created : CQuick_Slot_Item"));
...
CGameObject* CQuick_Slot_Item::Clone(void* pArg)
{
    CQuick_Slot_Item* pInstance = new CQuick_Slot_Item(*this);
