...
private:
	CBody_Alchina(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CBody_Alchina(const CBody_Alchina& Prototype);
	virtual ~CBody_Alchina() = default;
...
public:
	static CBody_Alchina* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
