...
namespace Client
{
	...
	enum class COLLISION_LAYER { PLAYER = 0, PLAYER_VIEW, RAY, MONSTER , ITEM, WEAPON, TRIGGER, RESIST, END};
	
	enum class OBJECT_TYPE { PLAYER, PLAYER_VIEW, RAY,
							RESIST,ATTACK, MON_HEAD, MON_BODY, MON_SHOULDER_L, MON_SHOULDER_R,
