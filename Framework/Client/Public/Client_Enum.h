...
namespace Client
{
	...
	enum class COLLISION_LAYER { PLAYER = 0, RAY, MONSTER , ITEM, WEAPON, TRIGGER, RESIST, END};
	enum class OBJECT_TYPE { PLAYER, RAY, RESIST,MON_HEAD, MON_BODY, MON_SHOULDER_L, MON_SHOULDER_R, ITEM, WEAPON, EVENT, END };
